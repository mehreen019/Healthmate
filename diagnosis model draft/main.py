...
while True:
    ...
    if(current_state=="ss"):
        ...
        #print("similarity in ss: ", str(sim2), " mainsym2 in ss: ", mainsym2)
    ...
    if current_state=="sim2=0":
        ...
        if sim2<0:
            ...
            if(len(suggestions)>0):
                mainsym2=[]
                print("suggestions in sim2=0 reached")
                while i in range(len(suggestions)):
    ...
    if current_state=="possible_disease":
        ...
        if userAllSymp==[]:
            userAllSymp.append(temp1[2])
            userAllSymp.append(temp2[2])
    ...
    if current_state=="END":
        ...
        if result is not None:
            ...
            if result[0] not in userDisease or userDisease==[]:
                current_state = "fs"
